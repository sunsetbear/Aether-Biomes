...
public class AetherBiomesItems {
    ...
    public static final RegistryObject<Item> ATMOSINE_GLOVES = ITEMS.register("atmosine_gloves", () -> new AetherBiomesGlovesItem(0.35,"atmosine_gloves", () -> SoundEvents.ARMOR_EQUIP_IRON, new Item.Properties().durability(131)));
